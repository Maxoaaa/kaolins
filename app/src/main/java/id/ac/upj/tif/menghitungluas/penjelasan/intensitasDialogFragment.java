...
public class intensitasDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public intensitasDialogFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_intensitas_dialog, container, false);
        View view = inflater.inflate(R.layout.fragment_intensitas_dialog, container, false);
