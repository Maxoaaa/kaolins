...
public class Main6a_t_hasil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtxiXa1.setText( bave.getString("XiXa"));
        txtxiXa2.setText( bave.getString("XiXa"));
        txtxiXa3.setText( bave.getString("XiXa"));
        txtxiXa4.setText( bave.getString("XiXa"));
        txtxiXa5.setText( bave.getString("XiXa"));
        txtxiXa6.setText( bave.getString("XiXa"));
        txtxiXa7.setText( bave.getString("XiXa"));
        txtxiXa8.setText( bave.getString("XiXa"));
        txtxiXa9.setText( bave.getString("XiXa"));
        txtxiXa10.setText( bave.getString("XiXa"));

        txtXiXaX1.setText( bave.getString("XiXa2"));
        txtXiXaX2.setText( bave.getString("XiXa2"));
        txtXiXaX3.setText( bave.getString("XiXa2"));
        txtXiXaX4.setText( bave.getString("XiXa2"));
        txtXiXaX5.setText( bave.getString("XiXa2"));
        txtXiXaX6.setText( bave.getString("XiXa2"));
        txtXiXaX7.setText( bave.getString("XiXa2"));
        txtXiXaX8.setText( bave.getString("XiXa2"));
        txtXiXaX9.setText( bave.getString("XiXa2"));
        txtXiXaX10.setText( bave.getString("XiXa2"));

        txtKtr2.setText( bave.getString("XiXa2"));
        txtKtr5.setText( bave.getString("XiXa2"));
        txtKtr10.setText( bave.getString("XiXa2"));
        txtKtr25.setText( bave.getString("XiXa2"));
        txtKtr50.setText( bave.getString("XiXa2"));
        txtKtr100.setText( bave.getString("XiXa2"));
        txtKtr200.setText( bave.getString("XiXa2"));
        txtKtr1000.setText( bave.getString("XiXa2"));
        txtXtr2.setText( bave.getString("XiXa2"));
        txtXtr5.setText( bave.getString("XiXa2"));
        txtXtr10.setText( bave.getString("XiXa2"));
        txtXtr25.setText( bave.getString("XiXa2"));
        txtXtr50.setText( bave.getString("XiXa2"));
        txtXtr100.setText( bave.getString("XiXa2"));
        txtXtr200.setText( bave.getString("XiXa2"));
        txtXtr1000.setText( bave.getString("XiXa2"));
        txtxbar.setText( bave.getString("XiXa2"));
        txtSd.setText( bave.getString("XiXa2"));
